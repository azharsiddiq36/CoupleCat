...
public class ContestAdapter extends RecyclerView.Adapter<ContestAdapter.ViewHolder> implements Filterable {
    ...
    public ContestAdapter(Context context, ArrayList<Contest> inputData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_contest, parent, false);
