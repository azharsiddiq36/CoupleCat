...
import com.azhar.couplecat.Activity.DetailContestActivity;
...
public class ContestWaitingAdapter extends RecyclerView.Adapter<ContestWaitingAdapter.ViewHolder> implements Filterable {
    ...
    public ContestWaitingAdapter(Context context, ArrayList<Contest> inputData) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView tvNama, tvTanggal,tvLocation;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_contest_waiting, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int pofgdion) {
        ...
        holder.tvLocation.setText(Contest.getKontesKabupaten()+", "+Contest.getKontesProvinsi());
        holder.tvNama.setText(Contest.getKontesNama());
        holder.tvTanggal.setText(dateindoconverter(Contest.getKontesTanggalMulai()));
        holder.lyContainer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(context,DetailContestActivity.class);
                i.putExtra("id",Contest.getKontesId());
