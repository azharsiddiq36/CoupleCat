...
public class MyAccKontesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_myacccontest, container, false);
    ...
    private void loadData() {
        Call<ResponseContest> responseContestCall = coupleCatInterface.getMyContest(map.get(sessionManager.KEY_PENGGUNA_ID),"disetujui");
