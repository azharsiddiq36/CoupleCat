...
public class PersonalDataKtpFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_personal_data_foto_ktp, container, false);
    ...
    public void sendKtp() {
        ...
        coupleCatInterface.uploadKtp(partGambar, pengguna_id).enqueue(new Callback<ResponsePengguna>() {
            @Override
